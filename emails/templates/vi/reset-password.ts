export const resetPasswordTemplate = (actionUrl: string) => ({
    subject: "Đặt lại mật khẩu Tattoo Vision",
    html: `<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Đặt lại mật khẩu Tattoo Vision</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #f5f5f5;">
  <div style="max-width: 600px; margin: 40px auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
    ...
    <div style="padding: 40px 30px;">
      <h2 style="margin: 0 0 20px; color: #1a1a1a; font-size: 20px; font-weight: 600;">Bạn quên mật khẩu?</h2>
      <p style="margin: 0 0 25px; color: #4a4a4a; font-size: 16px; line-height: 1.5;">
        Đừng hoảng sợ! Chúng tôi đã nhận được yêu cầu đặt lại mật khẩu cho tài khoản Tattoo Vision của bạn.
      </p>
      ...
      <p style="margin: 0; color: #737373; font-size: 14px; text-align: center;">
        Nếu bạn không thực hiện yêu cầu này, mật khẩu hiện tại của bạn sẽ không thay đổi.
      </p>
    </div>
